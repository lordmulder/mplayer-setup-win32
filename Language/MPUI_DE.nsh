...
LangString MPLAYER_LANG_CAN_NOT_UPDATE           ${LANG_GERMAN} "Auf Ihrem System ist bereits eine Version von MPlayer für Windows installiert, die neuer als dieses Setup-Paket ist. Ein Update ist daher nicht möglich. Setup wird jetzt!"
LangString MPLAYER_LANG_COMPRESS_FILES           ${LANG_GERMAN} "Programmdateien optimieren"
LangString MPLAYER_LANG_COMPRESSING              ${LANG_GERMAN} "Optimiere:"
...
LangString MPLAYER_LANG_CONFIRM_UPDATE           ${LANG_GERMAN} "Auf Ihrem System ist bereits eine Version von MPlayer für Windows installiert, die der Version dieses Setup-Pakets entspricht. Möchten Sie dennoch fortfahren?"
...
LangString MPLAYER_LANG_FORCE_UPDATE             ${LANG_GERMAN} "Ihre MPlayer für Windows Installation wird aktualisiert!"
