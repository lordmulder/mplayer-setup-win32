...
LangString MPLAYER_LANG_CAN_NOT_UPDATE           ${LANG_ENGLISH} "The version of MPlayer for Windows currently installed on your computer is newer than the version contained in this installation package. Setup will exist now!"
