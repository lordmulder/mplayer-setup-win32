...
LangString MPLAYER_LANG_CAN_NOT_UPDATE           ${LANG_ENGLISH} "The version of MPlayer for Windows currently installed on your computer is newer than the version contained in this installation package. Setup will exit now!"
...
LangString MPLAYER_LANG_CONFIRM_UPDATE           ${LANG_ENGLISH} "The version of MPlayer for Windows currently installed on your computer is the same as the version contained in this installation package. Do you want to proceed anyway?"
...
LangString MPLAYER_LANG_FORCE_UPDATE             ${LANG_ENGLISH} "Existing MPlayer for Windows installation will be upgraded!"
