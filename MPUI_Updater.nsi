...
Section "-Select Mirror"
	...
	; Randomize!
	${StdUtils.RandMax} $0 16

	; Select the mirror now!
	${Select} $0
		${Case}  "0"
			StrCpy $Update_MirrorURL "http://muldersoft.chickenkiller.com/"
		${Case}  "1"
		...
		${Case}  "8"
			StrCpy $Update_MirrorURL "http://lamexp.osdn.io/"
		${Case}  "9"
			StrCpy $Update_MirrorURL "http://muldersoft.sourceforge.net/"
		${Case} "10"
			StrCpy $Update_MirrorURL "http://x264-launcher.osdn.io/"
		${Case} "11"
